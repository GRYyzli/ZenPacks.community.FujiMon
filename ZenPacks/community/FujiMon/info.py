...
from ZenPacks.community.FujiMon import interfaces


class FujitsuStorageCntlrInfo(ComponentInfo):
    implements(interfaces.IFujitsuStorageCntlrInfo)
...
class FujitsuRemoteAccessCntlrInfo(ComponentInfo):
    implements(interfaces.IFujitsuRemoteAccessCntlrInfo)
